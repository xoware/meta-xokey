/*
 * pots_results.c:
 *   Contains functions for logging results to results file
 */
/*
 ...
 */
FILE *pots_open_rf(char *fname)
{
   
   FILE *fp;

   if ((fp = fopen(fname, "w+")) == NULL ) {
      printf("pots_open_rf(): fopen(%s) failed %s <%d>\n",
...
/*
 * $Id: pots_results.c,v 1.3 2008/10/24 08:43:51 ysandeep Exp $
 * $Log: pots_results.c,v $
