...
extern FILE *pots_open_log(char *fname);
extern FILE *pots_open_file(char *fname);

extern Uint8 *getrandom (Uint8 *buf, int len);


/*
 * $Id: pots_proto.h,v 1.2 2008/03/10 10:22:58 kkiran Exp $
 * $Log: pots_proto.h,v $
